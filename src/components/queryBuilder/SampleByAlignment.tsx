...
export const SampleByAlignEditor = (props: SampleByAlignmentProps) => {
  return (
    <EditorFieldGroup>
      <EditorField
        tooltip={selectors.components.QueryEditor.QueryBuilder.ALIGN_TO.tooltip}
        label={selectors.components.QueryEditor.QueryBuilder.ALIGN_TO.label}
      >
        <Select
      ...
      <EditorField
        tooltip={selectors.components.QueryEditor.QueryBuilder.CALENDAR_OFF_TZ.tooltip}
        label={selectors.components.QueryEditor.QueryBuilder.CALENDAR_OFF_TZ.label}
      >
        <Input
          width={25}
          type="text"
