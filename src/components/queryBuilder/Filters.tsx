...
const filterOperators: Array<SelectableValue<FilterOperator>> = [
  ...
  { value: FilterOperator.ContainedBy, label: '<<' },
  { value: FilterOperator.ContainedByOrEqual, label: '<<=' },
  ...
  { value: FilterOperator.Match, label: '~' },
  { value: FilterOperator.NotMatch, label: '!~' },
