...
const MetricEditor = (props: {
  ...
  const aggregationTypes: Array<SelectableValue<BuilderMetricFieldAggregation>> = [
    ...
    { value: BuilderMetricFieldAggregation.Count_Distinct, label: 'Count_Distinct' },
    ...
    { value: BuilderMetricFieldAggregation.First, label: 'First' },
    { value: BuilderMetricFieldAggregation.FirstNotNull, label: 'FirstNotNull' },
    { value: BuilderMetricFieldAggregation.Last, label: 'Last' },
    { value: BuilderMetricFieldAggregation.LastNotNull, label: 'LastNotNull' },
    { value: BuilderMetricFieldAggregation.KSum, label: 'KSum' },
    { value: BuilderMetricFieldAggregation.NSum, label: 'NSum' },
    { value: BuilderMetricFieldAggregation.StDev, label: 'StdDev' },
    { value: BuilderMetricFieldAggregation.StDevPop, label: 'StdDevPop' },
    { value: BuilderMetricFieldAggregation.VarSamp, label: 'Variance' },
    { value: BuilderMetricFieldAggregation.VarPop, label: 'VariancePopulation' },
  ];
